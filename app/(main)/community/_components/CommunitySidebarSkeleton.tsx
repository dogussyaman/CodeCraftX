    ...
    <aside className="flex w-full flex-col gap-6 lg:w-[280px] lg:shrink-0">
      ...
      <Card className="overflow-hidden border-border bg-card">
        ...
        <CardContent className="px-4 pb-4 pt-2">
          ...
          <p className="mt-1 line-clamp-3 text-center text-sm text-muted-foreground">
            Yazılım dünyasında birlikte öğrenin, paylaşın ve büyüyün. Duyurular, blog ve kaynaklar tek yerde.
          </p>
      ...
      {/* Bağlan - tamamen statik, hemen */}
      <Card className="border-border bg-card">
        <CardContent className="p-4">
          <h3 className="text-sm font-semibold text-foreground">Bağlan</h3>
          <p className="mt-1 text-xs text-muted-foreground">
            Topluluğa Discord, GitHub ve LinkedIn üzerinden ulaşın.
          </p>
          <div className="mt-3 flex flex-wrap gap-2">
            ...
            <Button variant="outline" size="sm" asChild className="gap-1.5">
              <a href={COMMUNITY_GITHUB_URL} target="_blank" rel="noopener noreferrer">
            ...
            <Button variant="outline" size="sm" asChild className="gap-1.5">
              <a href={COMMUNITY_LINKEDIN_URL} target="_blank" rel="noopener noreferrer">
                <svg className="size-4" viewBox="0 0 24 24" fill="currentColor" aria-hidden>
      ...
      {/* Konular - başlık ve varsayılan liste hemen (statik etiketler) */}
      <Card className="border-border bg-card">
        <CardContent className="p-4">
          <div className="flex items-center justify-between">
            <h3 className="text-sm font-semibold text-foreground">Konular</h3>
