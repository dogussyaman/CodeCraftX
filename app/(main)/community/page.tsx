  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className="container mx-auto px-4 py-6 md:py-8">
        ...
        <Suspense fallback={<CommunityColumnsFallback />}>
          <CommunityDataColumns />
        </Suspense>

        <CommunityStaticSections />
      </div>
    </div>
  )
}

async function CommunityDataColumns() {
...
function CommunityColumnsFallback() {
  return (
    <div className="flex flex-col gap-8 lg:flex-row lg:items-start lg:gap-8">
...
function CommunityStaticSections() {
  return (
    <>
