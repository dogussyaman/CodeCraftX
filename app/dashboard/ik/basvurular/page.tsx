          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="mt-1 text-sm text-muted-foreground dark:text-foreground/75">
                İlan bazında başvuruları, AI uyum oranlarını ve süreç durumlarını yönetin.
              </p>
            </div>
          </div>
          {jobs && jobs.length > 0 && (
          ...
          <Card className="overflow-hidden rounded-2xl border-2 border-dashed border-muted-foreground/20 bg-muted/20 shadow-none">
            <CardContent className="flex flex-col items-center justify-center py-20 px-6">
              ...
              <p className="mt-2 max-w-sm text-center text-sm text-muted-foreground">
                İlan oluşturulduğunda, bu ekrandan İK tarafında başvuruları yönetebilirsiniz.
              </p>
            </CardContent>
          </Card>
        ) : (
                ...
                >
                  <CardHeader className="pb-3">
                    <div className="flex items-start justify-between gap-3">
                      ...
                      >
                        <Link href={`/dashboard/ik/basvurular/${job.id}`} className="gap-1.5">
